      ...
      render: (_, record) => (
        <Space>
          <Button
            type="text"
            icon={
              <FontAwesomeIcon icon={faFile} style={{ color: "#1677ff" }} />
            }
          ...
          <Button
            type="text"
            icon={
              <FontAwesomeIcon icon={faPencil} style={{ color: "#fa8f14" }} />
            }
            onClick={() => onEdit(record)}
            title="Sửa"
          />
          <Popconfirm title="Xóa đề thi?" onConfirm={() => onDelete(record.id)}>
            <Button
              type="text"
              icon={
