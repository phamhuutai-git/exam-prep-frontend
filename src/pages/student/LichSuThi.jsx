...
import { Card, Input, Typography, Row, Col, Progress, Badge } from "antd";
                        ...
                        <Card hoverable style={{ borderRadius: 16 }}>
                            ...
                            <div
                                style={{
                                    ...
                                    marginBottom: 12,
                                    paddingBottom: 8,
                                    borderBottom: "1px solid #f0f0f0", // 🔥 Đã xóa viền Xanh/Đỏ, thay bằng viền mờ nhạt
                                }}
                            >
                                <Typography.Text strong>
                                    {exam.title}
                                </Typography.Text>
                                {/* 🔥 Đã xóa thẻ <Tag> Đạt/Không Đạt ở đây */}
                            </div>
                            ...
                            {/* SCORE */}
                            <div>
                                <Progress percent={exam.score} size="small" />
